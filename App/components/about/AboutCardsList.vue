<template>
    <v-layout row wrap fill-height>
        <v-flex v-for="(item, i) in cardItems" v-bind:key="i" lg4 sm6 xs12>
    ...
    export default {
        ...
        data: () => ({
            ...
            },
            {
                ...
                'Art used on the main page were made by haimerejzero and プシュケー respectively - you can find them on pixiv.'
                ]
            }
            ]
        })
